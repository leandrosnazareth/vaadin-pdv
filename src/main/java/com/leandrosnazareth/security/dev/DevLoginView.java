package com.leandrosnazareth.security.dev;
...
class DevLoginView extends Main implements BeforeEnterObserver {
    ...
    DevLoginView(AuthenticationContext authenticationContext) {
        ...
        var exampleUsers = new Div(new Div("Use as seguintes credenciais para fazer login:"));
        ...
        var devModeMenuDiv = new Div("Você também pode usar o menu do modo Dev aqui para representar qualquer usuário");
